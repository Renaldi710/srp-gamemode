...
CMD:settdminfo(playerid, params[])
{
    ...
    if(!strcmp(name, "health", true))
    {
        ...
        EventHP = health;
        SendAdminMessage(X11_TOMATO, "%s set Health tdm to %d.", pData[playerid][pAdminname], health);
    }
    if(!strcmp(name, "prize", true))
    {
        ...
        EventPrize = health;
        SendAdminMessage(X11_TOMATO, "%s set Prize tdm to %d.", pData[playerid][pAdminname], health);
    }
    if(!strcmp(name, "armor", true))
    {
        ...
        EventArmour = armor;
        SendAdminMessage(X11_TOMATO, "%s set Armour tdm to %d.", pData[playerid][pAdminname], armor);
    }
    if(!strcmp(name, "maxplayer", true))
    {
        ...
        MaxRedTeam = armor;
        MaxBlueTeam = armor;
        SendAdminMessage(X11_TOMATO, "%s set maxplayer tdm to %d.", pData[playerid][pAdminname], armor);
    }
	if(!strcmp(name, "weapon1", true))
    {
        ...
        SendAdminMessage(X11_TOMATO, "%s set weapon 1 tdm to %d.", pData[playerid][pAdminname], ReturnWeaponName(weaponid));
    }
    if(!strcmp(name, "weapon2", true))
    {
        ...
        SendAdminMessage(X11_TOMATO, "%s set weapon 2 tdm to %d.", pData[playerid][pAdminname], ReturnWeaponName(weaponid));
    }
    if(!strcmp(name, "weapon3", true))
    {
        ...
        SendAdminMessage(X11_TOMATO, "%s set weapon 3 tdm to %d.", pData[playerid][pAdminname], ReturnWeaponName(weaponid));
    }
    if(!strcmp(name, "weapon4", true))
    {
        ...
        SendAdminMessage(X11_TOMATO, "%s set weapon 4 tdm to %d.", pData[playerid][pAdminname], ReturnWeaponName(weaponid));
    }
    if(!strcmp(name, "weapon5", true))
    {
        ...
        SendAdminMessage(X11_TOMATO, "%s set weapon 5 tdm to %d.", pData[playerid][pAdminname], ReturnWeaponName(weaponid));
    }
    return 1;
}
...
CMD:tdmpos(playerid, params[])
{
    ...
    if(!strcmp(name, "red", true))
    {
        ...
        SendAdminMessage(X11_TOMATO, "%s set red pos to %0.2f %0.2f %0.2f .", pData[playerid][pAdminname], RedX, RedY, RedZ);
    }
    if(!strcmp(name, "blue", true))
    {
    	...
    	EventInt = GetPlayerInterior(playerid);
    	EventWorld = GetPlayerVirtualWorld(playerid);
        SendAdminMessage(X11_TOMATO, "%s set blue pos to %0.2f %0.2f %0.2f .", pData[playerid][pAdminname], BlueX, BlueY, BlueZ);
    }
    return 1;
}