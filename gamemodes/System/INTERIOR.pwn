...
CMD:gotointerior(playerid, params[])
{
	...
	for (new i = 0; i < sizeof(g_arrInteriorData); i ++)
	{
   	...
   	Dialog_Show(playerid, DIALOG_INTERIOR, DIALOG_STYLE_LIST, "Teleport: Interior List", str, "Select", "Cancel");
    return 1;
}

Dialog:DIALOG_INTERIOR(playerid, response, listitem, inputtext[])
{	
    if (response)
    {
