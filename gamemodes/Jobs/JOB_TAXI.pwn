...
CreateJoinTaxiPoint()
{
	//JOBS
	new strings[128];
	CreateDynamicPickup(1239, 23, 1685.3975,-1464.5696,13.6719, -1);
	format(strings, sizeof(strings), "[TAXI JOBS]\n{ffffff}Jadilah Pekerja Taxi disini\n{7fff00}/getjob /accept job");
	CreateDynamic3DTextLabel(strings, COLOR_YELLOW, 1685.3975,-1464.5696,13.6719, 3.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1); // Taxi
}
